...
void rl_to_string__int64_t_r_String(String* out, int64_t* toConvert)
{
	char buffer[256];
	sprintf(buffer, "%" PRId64, *toConvert);
	rl_m_init__String(out);
	rl_m_append__String_strlit(out, buffer);
}

void rl_to_string__int8_t_r_String(String* out, int8_t* toConvert)
{
	char buffer[256];
...
void rl_to_string__double_r_String(String* out, double* toConvert)
{
	char buffer[256];
